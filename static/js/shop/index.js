...
! function e(t, n, i) {
    ...
    50: [function(e, t, n) {
        ...
        function i() {
            d = new l.Texture(u.add(a.assetPath + "static/images/spot.png").content), d.needsUpdate = !0
        }
    ...
    51: [function(e, t, n) {
        ...
        function i() {
            w.add(p.assetPath + "static/images/particles_blend.jpg", {
                onLoad: function(e) {
    ...
    52: [function(e, t, n) {
        ...
        function i() {
            ...
            M = new _.Texture(g.add(m.assetPath + "static/images/diffuse_" + e + ".jpg").content), M.wrapS = _.RepeatWrapping, M.wrapT = _.RepeatWrapping, M.needsUpdate = !0, P = new _.Texture(g.add(m.assetPath + "static/images/extras_" + e + ".jpg").content), P.wrapS = _.RepeatWrapping, P.wrapT = _.RepeatWrapping, P.needsUpdate = !0, b.preInit()
        }
    ...
    53: [function(e, t, n) {
        ...
        function r() {
            d = new u.Texture(c.add(s.assetPath + "static/images/earth_pin_ring.png").content), d.needsUpdate = !0, f = new u.PlaneBufferGeometry(.5, .5), p = new u.Matrix4, m = new u.Vector3, v = new u.Quaternion, _ = new u.Vector3
        }
    ...
    63: [function(e, t, n) {
        ...
        function i() {
            s.add(a.assetPath + "static/data/" + a.dataProfile + ".json", {
                onLoad: function(e) {
                    n.data = e
                }
            })
    ...
    66: [function(e, t, n) {
        ...
        function c(e) {
            function t() {
                m.play("bgm", !0), document.body.removeEventListener("click", t), document.body.style.cursor = "auto", document.body.classList.add("end"), canv.style.display = "none",story.style.display = "none",main.style.display = "none",viewModes.style.display = "none", h(e)
            }
            _.to(x, .5, {
                opacity: 1,
                onComplete: function() {
    ...
    72: [function(e, t, n) {
        ...
        function r() {
           L && L.addEventListener("click", p), x.onRouteChangeStarted.add(o), x.onRouteChangeCompleted.add(a)
        }
    ...
    77: [function(e, t, n) {
        ...
        function i(e) {
            this.id = e.id, this.data = e, this.category = this.data.category, this.continent = this.category.continent, e.content = this, this.container = l.createElement(h({
                project: e
            })), this.container.content = this, this.hasDetailsInitialized = !1, this.storyIndex = void 0 === e.storyIndex ? -1 : e.storyIndex, s.useWebGL && (this.thumbImage = c.add(s.assetPath + "static/thumbnails/" + this.data.id + ".jpg").content), this.nodeContainer = null, this.storyContainer = null
        }
    ...
    79: [function(e, t, n) {
        ...
        function r(e) {
            A[e] = m.add(h.assetPath + "static/audios/" + e + "." + d.audioFormat, {
                type: "audio"
            }).content
        }
